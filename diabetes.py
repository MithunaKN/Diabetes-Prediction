...
with tab1:
    ...
    st.markdown("## Hey guy, Are you scared to go to the doctor to check your diabetes condition?")
    st.markdown("##### You don't have to worry. This app would be helpful to check your diabetes without consulting the doctor.")
    st.markdown("##### You just have to enter certain details that are asked regarding your health conditions and your results will be given in no time.")
...
with tab2:
    ...
    if st.button('submit'):
        ...
        if y_pred == 0:
            st.metric(label='Your result',value="No diabetes(enjoy your sweet time)")
        else: 
            st.metric(label='Your result',value="You have diabetes(consult with a doctor)")
